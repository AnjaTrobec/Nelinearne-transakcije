...
opt_fit <- function(price, profit){
  if (cor(price, profit) < 0){
    ...
    if (er1 > er2){
      ...
      komentar <- paste("Približek za izvršilno ceno opcije je ", as.character(strike_price), " EUR/MWh,", " za količino ", as.character(količina), " MWh", " in za premijo ", as.character(premija), " EUR", ".",sep="")
      print(komentar)
