...
Moja naloga je poiskati Evropsko opcijo, ki najboljše opiše nelinearno transakcijo predstavljeno v podatkih. Vhodni podatki so pari, v katerih prva komponenta predstavlja ceno (*$S_t$* - *cena ob času t*) in druga komponenta izplačilo pri dani ceni (*$V_t$* - *vrednost opcije v času t*). Cena je izrazena v EUR/MWh, izplačilo pa v EUR.
