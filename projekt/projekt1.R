...
putPayoff <- function(S,K,premium) pmax(0-premium,K-S-premium)

# VALUE OF EU PUT OPTION
callV <- function(S,K) pmax(0,S-K)
callPayoff <- function(S,K,premium) pmax(0-premium,S-K-premium)
...
st <- round(stevec_negativnih*0.05,0)
...
lines(price, putPayoff(price,210,10), col='red')
